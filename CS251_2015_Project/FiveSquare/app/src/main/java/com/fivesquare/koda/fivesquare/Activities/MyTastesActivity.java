...
public class MyTastesActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_tastes);

        ArrayList<Taste> mytastes= new ArrayList<>(db.getUserTastes(MainControlller.user.getID()));
        Log.e("MYTASTE" , ""+mytastes.toString());
       for(int i=0; i<mytastes.size() ;i++){
           Button myButton = new Button(this);
           myButton.setText(mytastes.get(i).getName());
           myButton.setEnabled(false);
           LinearLayout ll = (LinearLayout)findViewById(R.id.mytastesLL);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Profile) {
            Intent intent = new Intent(MyTastesActivity.this, MyProfileActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Home) {
            Intent intent = new Intent(MyTastesActivity.this, HomeActivity.class);
            startActivity(intent);
            finish();

        } else if (id == R.id.nav_Chat) {
            Intent intent = new Intent(MyTastesActivity.this, ChatActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Notifications) {
            Intent intent = new Intent(MyTastesActivity.this, NotificationActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Search) {
            Intent intent = new Intent(MyTastesActivity.this, SearchActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Tastes) {
            Intent intent = new Intent(MyTastesActivity.this, TasteActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_Logout) {
            Intent intent = new Intent(MyTastesActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        }
